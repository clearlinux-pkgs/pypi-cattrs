...
Source0  : https://files.pythonhosted.org/packages/64/65/af6d57da2cb32c076319b7489ae0958f746949d407109e3ccf4d115f147c/cattrs-24.1.2.tar.gz
...
%prep
%setup -q -n cattrs-24.1.2
cd %{_builddir}/cattrs-24.1.2
pushd ..
cp -a cattrs-24.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727041467
