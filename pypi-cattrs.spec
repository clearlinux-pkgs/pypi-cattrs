...
Source0  : https://files.pythonhosted.org/packages/f2/9c/22b4010404d899d7012474f1539c4163b22e77ca55f444e945c2095dbdde/cattrs-24.1.0.tar.gz
...
%prep
%setup -q -n cattrs-24.1.0
cd %{_builddir}/cattrs-24.1.0
pushd ..
cp -a cattrs-24.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724864180
