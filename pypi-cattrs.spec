...
Source0  : https://files.pythonhosted.org/packages/29/7b/da4aa2f95afb2f28010453d03d6eedf018f9e085bd001f039e15731aba89/cattrs-24.1.3.tar.gz
...
%prep
%setup -q -n cattrs-24.1.3
cd %{_builddir}/cattrs-24.1.3
pushd ..
cp -a cattrs-24.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742921953
