...
Source0  : https://files.pythonhosted.org/packages/3c/ba/08912e7e6e796fa7d5da1aaf3f53235ee6b2a73ec51d93bdf69b77b1c0d1/cattrs-24.1.1.tar.gz
...
%prep
%setup -q -n cattrs-24.1.1
cd %{_builddir}/cattrs-24.1.1
pushd ..
cp -a cattrs-24.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726062573
